...
if view_time
    tant0=tAntData(:,1);
    tant1=tAntData(:,3);
    slotCollectFreq0=plot1msSignal(tant0,0);
    slotCollectFreq1=plot1msSignal(tant1,1);
...
if view_freq
    ...
    slotCollectFreq0=plot1msFreqencySignal(fant0,0);
    slotCollectFreq1=plot1msFreqencySignal(fant1,1);
    %% view detail signal
    slotScLen=3276*14;
...
%% use DMRS to frequency offset cancellor
v_slot=9;
FastDemod(slotCollectFreq0,slotCollectFreq1,v_slot);
%%
t=now;
datestr(t,0)
